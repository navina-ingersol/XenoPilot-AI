...
function generateMockStrategyAnalysis(prompt: string, campaign: GeneratedCampaign): StrategyAnalysis {
  ...
  return {
    ...
    whyCustomers: [
  "Audience selected from the uploaded customer and order data.",
  "The segment was matched to the campaign objective provided by the marketer.",
  "This audience was chosen as the most relevant group for the generated campaign.",
],
    whyChannel: [
  `${campaign.channel} was selected based on the campaign objective and audience.`,
  "The channel aligns with the communication style required for this campaign.",
  "The message content was generated and adapted for the selected channel.",
],
    predictedRevenue,
